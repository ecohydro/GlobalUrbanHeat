...
# def make_hi(zipped_in, path):
    
#     """ Takes an RH and Tmax file zipped together and writes a heat index tif
#     Args:
#         zipped = zipped RH [0] and tmax [1] file path/name
#         path = path/to/himax_out 
#     """

#     # get data date
#     date =zipped_in[0].split('RH.')[1].split('.tif')[0]
    
#     # get meta data
#     meta = rasterio.open(zipped_in[0]).meta
#     meta['dtype'] = 'float64'
...
#     # write it out
#     fn_out = os.path.join(path,data_out+'.'+date+'.tif')
#     print(fn_out)
...
if __name__ == "__main__":
    ...
    # run it
    zipped_dir_list = zipped_dir_list[:5]
